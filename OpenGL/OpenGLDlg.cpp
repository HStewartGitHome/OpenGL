...
COpenGLDlg::COpenGLDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(COpenGLDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDTEST, &COpenGLDlg::OnBnClickedTest)
	ON_BN_CLICKED(IDINFO, &COpenGLDlg::OnBnClickedInfo)
END_MESSAGE_MAP()
...
void COpenGLDlg::OnBnClickedTest()
{
...
void COpenGLDlg::OnBnClickedInfo()
{
	// TODO: Add your control notification handler code here
	COpenGLInfo infoDlg;
	infoDlg.DoModal();
